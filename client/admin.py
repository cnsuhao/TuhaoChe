...
class NewsAdmin(ModelAdmin):
    columns = ('user', 'text', 'favorited', 'thumbnail_pic', 'bmiddle_pic', 'original_pic', 'reposts_count', 'comments_count', 'attitudes_count',  "screen_name, name", "profile_image_url", "avatar_large", "uid", "ret_text", 'created_at',)
